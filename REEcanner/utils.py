...
class BlacklistManager:
    def __init__(self, include_recommended: bool = True, allow_private: bool = False, custom_networks: List[str] = None):
        ...
        if include_recommended:
            networks.extend(["148.59.85.0/24", "6.0.0.0/8", "7.0.0.0/8", "11.0.0.0/8", "21.0.0.0/8", "22.0.0.0/8", "26.0.0.0/8", "28.0.0.0/8", "29.0.0.0/8", "30.0.0.0/8", "33.0.0.0/8", "55.0.0.0/8", "214.0.0.0/8", "215.0.0.0/8"])
